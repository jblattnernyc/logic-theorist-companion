...
Parser outputs and formal reports are derived evidence records. They should be generated from preserved run bundles and stored in the companion repository, normally under a per-run directory in `reports/`.
